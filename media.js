  ...
  function initMediaData() {
    return {
      ...
      descriptions: {
        ...
        1: "This video shows a “day in the life” of StreetSafe Bridgeport workers in their mission to help the troubled youth of Bridgeport, CT. It discusses the outreach workers who were hired to connect with the youth, most of whom were formerly in prison and had similar experiences to the youth they are trying to connect with. The video shows scenes of one outreach worker who spoke to local children at a summer basketball camp, in which he tries to instill life lessons with the children, encouraging them to come off the street corners and participate in positive social activities. He explains how he chose the wrong path and went to prison and wants to inspire them to not make the wrong decisions and instead focus on their education and positive things. They show conversations between the outreach worker and Bridgeport teens about the reality of poor opportunities for them in the community. The video goes on to explain that StreetSafe Bridgeport provides consistency in their outreach to the troubled youth. They want to see the Bridgeport youth reach their full potential. They point out that with the lack of alternative activities and jobs for Bridgeport youth, more programming like StreetSafe Bridgeport is needed to redirect their lives. They emphasize the need for more funding to continue their important programming to continue to give hope for troubled youth to change their lives.",
